    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Dokumentasi Gambar XL</h1>
                </div>
            </div>
            <form method="post" action="{{ route('dokumentasi.storeXL') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        @if(Auth::user()->role == 'Administrator')
                            <div class="menu-container">
                                ...
                                <div class="menu-content">
                                    <form action="{{ route('dokumentasi.destroyXL', $item->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
