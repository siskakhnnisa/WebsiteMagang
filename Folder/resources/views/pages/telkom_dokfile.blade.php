...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="{{ asset('css/dokfile.css') }}">

    <title>Upload File GPS</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Dokumentasi File GPS</h1>
                </div>
            </div>
            <hr class="horizontal-line">
            <div class="container-kiri">
                <form method="post" action="{{ route('file.storeTelkom') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <table class="gallery-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('file.downloadTelkom', $file->dokumen) }}" class="download-btn">Download</a>
                                @if(Auth::user()->role == 'Administrator')
                                <form action="{{ route('document.deleteTelkom', $file->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
