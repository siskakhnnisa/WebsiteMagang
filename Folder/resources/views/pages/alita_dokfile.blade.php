    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Dokumentasi File Alita</h1>
                </div>
            </div>
            <hr class="horizontal-line">
            <div class="container-kiri">
                <form method="post" action="{{ route('file.storeAlita') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <table class="gallery-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('file.downloadAlita', $file->dokumen) }}" class="download-btn">Download</a>
                                @if(Auth::user()->role == 'Administrator')
                                <form action="{{ route('document.deleteAlita', $file->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
