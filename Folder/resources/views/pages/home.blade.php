...
<head>
	...
	<title>Monitoring Progress Iforte</title>
</head>
<body>
...
<body>
    ...
    <script>
        ...
        // add new ring
        $(document).on('click', '#add_new_ring', function(e){
            var no_spk = $('#get_no_spk').val();
            // redirect to '/iforte_add_ring/' + no_spk, controller
            window.location.href = '/iforte_add_ring/' + no_spk;
        });
		...
		// Add new segment
		$(document).on('click', '#add_new_segment', function(e){
			var ring_id = $('#get_ring_id').val();
			// redirect to '/iforte_add_segment/' + ring_id, controller
			window.location.href = '/iforte_add_segment/' + ring_id;
		});


		$(document).on('click', '.action-segment a[href="dokgambar.html"]', function(e){
		    e.preventDefault();
		    var segment_id = $(this).closest('tr').find('input[type="hidden"]').last().val();
		    window.location.href = '/dokgambar?segment_id=' + segment_id;
		});
