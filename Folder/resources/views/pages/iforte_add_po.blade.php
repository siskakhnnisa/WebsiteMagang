...
<link rel="stylesheet" href="{{ asset('css/iforte_add_po.css') }}">
</head>
<body>
<div class="form-container">
    ...
    <form method="" action="" enctype="">
     ...
     <div class="form-group">
        ...
        <input type="text" id="project-name" name="nama_projek" placeholder="Masukkan nama projek...">
    </div>
    <div class="form-group">
        <label for="spk-number">Nomor SPK:</label>
        <input type="text" id="spk-number" name="no_spk" placeholder="Masukkan nomor SPK...">
    </div>
    <div class="form-group">
        <a href=#>
...
<div class="form-container">
    <h2>Input Data Project</h2>
    <form method="post" action="{{ route('ifortepo.store') }}" enctype="multipart/form-data">
    @csrf
    @if ($errors->any())
        <div class="alert alert-danger">
