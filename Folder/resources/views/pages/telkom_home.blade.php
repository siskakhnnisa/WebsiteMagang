...
<head>
	...
	<title>Monitoring Progress GPS</title>
</head>
<body>
   ...
   <!-- SIDEBAR -->
	...
	<section id="content">
		...
		<main>
			...
			<!-- PO -->
			<a href="telkom_add_po" class="btn-tambah">
				<b>+</b>
    ...
    <script>
        ...
        // add new ring
        $(document).on('click', '#add_new_ring_telkom', function(e){
            var no_spk = $('#get_no_spk').val();
            window.location.href = '/telkom_add_ring/' + no_spk;
        });
                            ...
                            $('#segment1').append(
                                '<tr id="fetch_data_segment">'+
                                    ...
                                    '<td class="action-segment">'+
                                        '<a href="telkom_dokfile.html">'+
                                        '<img src="img/dokumen.png">'+
                                        '</a>'+
                                        '<a href="telkom_dokgambar.html">'+
		...
		// Add new segment
		$(document).on('click', '#add_new_segment_telkom', function(e){
			var ring_id = $('#get_ring_id').val();	
			window.location.href = '/telkom_add_segment/' + ring_id;
		});


		$(document).on('click', '.action-segment a[href="telkom_dokgambar.html"]', function(e){
		    e.preventDefault();
		    var segment_id = $(this).closest('tr').find('input[type="hidden"]').last().val();
		    window.location.href = '/telkom_dokgambar?segment_id=' + segment_id;
		});

		$(document).on('click', '.action-segment a[href="telkom_dokfile.html"]', function(e){
		    e.preventDefault();
		    var segment_id = $(this).closest('tr').find('input[type="hidden"]').last().val();
		    window.location.href = '/telkom_document?segment_id=' + segment_id;
		});
